...
export const Showtable = ()=>{
    ...
    return (
      ...
      >
        ...
        <button
          className="cursor-pointer border-2 border-slate-300  hover:bg-purple-500 hover:text-white hover:font-medium duration-500 bg-purple-400 px-3 py-1 text-white rounded-lg m-5 absolute right-0"
          onClick={resetHandle}
        >
          Reset
        </button>
